...
Xtrain_path = "hf://datasets/Akhilesh1108/Project/Xtrain.csv"
Xtest_path = "hf://datasets/Akhilesh1108/Project/Xtest.csv"
ytrain_path = "hf://datasets/Akhilesh1108/Project/ytrain.csv"
ytest_path = "hf://datasets/Akhilesh1108/Project/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "Akhilesh1108/predict-model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_predict_model_v1.joblib",
        path_in_repo="best_predict_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
